...
import { equal, deepEqual, notEqual } from 'assert'; // importing multiple members
import { equal as myEqual } from "assert"; // giving alias for the import
import { default as myAssert } from "assert"; // giving default alias for entire import
...
describe('use `import` to import functions that have been exported (somewhere else)', function() {
  describe('the import statement', function() {
    ...
    it('import an entire module using `import <name> from "<moduleName>"`', function() {
      ...
      // not sure why we needed to check the type. the only thing important is to know how to import something
