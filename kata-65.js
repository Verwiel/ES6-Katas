...
describe('`Set` API overview', function(){
  ...
  it('a Set can be created from an array', function() {
    ...
    let set = new Set(api);
    // created set from the api variable above
  ...
  it('`add()` appends the given value', function() {
    ...
    // added symbol.iterator like the promp suggested
  ...
  it('`delete()` removes the given value', function() {
    ...
    set.delete('size')
    // deleted one of the entries so the size would go down 1
  ...
  describe('returns an iterator that contains all values', function() {
    ...
    it('`keys()`', function() {
      ...
      // changed object to set nd removed set from the keys()
    ...
    it('`values()`', function() {
      ...
      // same concept as the last one, needed to add s to value to make it work
    ...
    it('`[Symbol.iterator]()`', function() {
      ...
      // see previous Symbol.iterator kata
